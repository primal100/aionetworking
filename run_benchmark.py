...
def setup_logging(level, sender_loglevel, asyncio_debug):
...
if __name__ == '__main__':
    ...
    setup_logging(args.loglevel, args.senderloglevel, args.asyncio_debug)
    ...
    asyncio.run(run(args.clients, args.num, args.slow_duration, args.asyncio_debug, args.pause_on_size, args.times, args.timeout))
