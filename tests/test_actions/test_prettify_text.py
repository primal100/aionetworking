...
"""})
    ...
    def test_05_do(self):
        ...
        expected_file = os.path.join(self.base_home, 'Prettified', 'JsonLogHandler', '10.10.10.10_0.txt')
...
""")
    ...
    def test_06_do_many(self):
        ...
        expected_file = os.path.join(self.base_home, 'Prettified', '10.10.10.10_JsonLogHandler.txt')
        self.assertFileContentsEqual(expected_file,
                                     """Time: 2018-09-15 11:09:31.033925
Object_id: 1234
Operation: Modify
