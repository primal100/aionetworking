...
class TestMessageManager(BaseTestCase):
    ...
    def test_03_manage_multiple_messages(self):
        ...
        expected_file = os.path.join(self.base_data_dir, 'Decoded', 'Primary_TCAP_MAP.txt')
        ...
        expected_file = os.path.join(self.base_data_dir, 'Prettified', 'Primary_TCAP_MAP.txt')
        self.assertFileContentsEqual(expected_file,
                                     """Event_type: begin
Otid: 00000001
