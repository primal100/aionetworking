...
class TestTwoWayReceiverAdaptor:
    @pytest.mark.asyncio
    async def test_00_on_data_received(self, tmp_path, two_way_receiver_adaptor, echo_encoded, timestamp,
                                       echo_response_encoded, echo_recording_data, queue, json_codec):
    ...
    @pytest.mark.asyncio
    async def test_01_notifications(self, tmp_path, two_way_receiver_adaptor, echo_notification_client_encoded, timestamp,
    ...
    @pytest.mark.asyncio
    async def test_02_on_exception(self, two_way_receiver_adaptor, echo_exception_request_encoded, caplog,
    ...
    @pytest.mark.asyncio
    async def test_03_response_on_decode_error(self, two_way_receiver_adaptor, echo_request_invalid_json, timestamp,
...
class TestSenderAdaptorTwoWay:
    @pytest.mark.asyncio
    async def test_00_wait_notification(self, two_way_sender_adaptor, echo_notification_object):
    ...
    def test_01_get_notification(self, two_way_sender_adaptor, echo_notification_object):
        two_way_sender_adaptor._notification_queue.put_nowait(echo_notification_object)
        notification = two_way_sender_adaptor.get_notification()
        assert notification == echo_notification_object

    def test_02_all_notifications(self, two_way_sender_adaptor, echo_notification_object):
        two_way_sender_adaptor._notification_queue.put_nowait(echo_notification_object)
        two_way_sender_adaptor._notification_queue.put_nowait(echo_notification_object)
    ...
    @pytest.mark.asyncio
    async def test_03_on_data_received_response(self, two_way_sender_adaptor, echo_response_encoded, timestamp,
                                                echo_response_object, json_client_codec):
        fut = asyncio.Future()
    ...
    @pytest.mark.asyncio
    async def test_04_on_data_received_notification(self, two_way_sender_adaptor, echo_notification_server_encoded,
    ...
    @pytest.mark.asyncio
    async def test_05_send_data_and_wait(self, two_way_sender_adaptor, echo_encoded, echo_response_encoded, timestamp,
    ...
    @pytest.mark.asyncio
    async def test_06_send_msg_and_wait(self, two_way_sender_adaptor, echo_request_object, echo_encoded,
    ...
    @pytest.mark.asyncio
    async def test_07_encode_send_wait(self, two_way_sender_adaptor, echo, echo_encoded, timestamp,
    ...
    @pytest.mark.asyncio
    async def test_08_run_method_and_wait(self, two_way_sender_adaptor, echo_encoded, timestamp,
                                          echo_response_encoded, echo_response_object, queue):
    ...
    @pytest.mark.asyncio
    async def test_09_run_method_notification(self, two_way_sender_adaptor, echo_notification_client_encoded, queue,
    ...
    @pytest.mark.asyncio
    async def test_10_no_method(self, two_way_sender_adaptor):
